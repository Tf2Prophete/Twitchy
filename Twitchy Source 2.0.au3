...
Func _ShowGui()
	...
	GUICtrlCreateLabel("© TF2Prophete v2.0", 155, 152, 200, 50)
	GUICtrlSetFont(-1, 7)
...
Func _EditKeyBinding()
	...
	Else
		...
		While $NewKeyData = ""
			$NewKeyData = InputBox("Twitchy", "What would you like to assign to this key?" & @CRLF & @CRLF & "Please note, some special characters such as ! and some others will not work!" & @CRLF & @CRLF & "If you wish to add in a custom text during the paste, put the word 'TEXT' without quotes where you want it!")
			If $NewKeyData = "" Then
